...
namespace BattleSystem
{
    ...
    public class EnemyCombatTendency
    {
        ...
        public void SortSpells()
        {
            ...
            spellDictionary.Add(SpellType.Damage, new List<SpellData>());
        ...
        {
            if (spellDictionary == null || spellDictionary.Count == 0) SortSpells();
            ...
            if(_spellDictionary[SpellType.Damage].Count <= 0) _spellDictionary.Remove(SpellType.Damage);
